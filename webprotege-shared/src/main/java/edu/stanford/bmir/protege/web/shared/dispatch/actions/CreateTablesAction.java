 ...
 * Date: 25/09/2019
 */
public class CreateTablesAction extends AbstractNohrAction<CreateRulesResult, NohrRule> {

    private String sourceText;

    private CreateTablesAction() {
    }

    public CreateTablesAction(@Nonnull ProjectId projectId,
