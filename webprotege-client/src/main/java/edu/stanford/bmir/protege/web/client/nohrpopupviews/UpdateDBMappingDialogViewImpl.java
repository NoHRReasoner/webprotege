 ...
 */
public class UpdateDBMappingDialogViewImpl extends Composite implements UpdateDBMappingDialogView, HasAcceptKeyHandler {

    interface UpdateDBMappingDialogViewImplUiBinder extends UiBinder<HTMLPanel, UpdateDBMappingDialogViewImpl> {
    }

    private static UpdateDBMappingDialogViewImplUiBinder ourUiBinder = GWT.create(UpdateDBMappingDialogViewImplUiBinder.class);
    ...
    @Inject
    public UpdateDBMappingDialogViewImpl(@Nonnull Messages messages) {
