...
//    }
    ...
    private Rule rule(AbstractPrologTerm term) throws IOException, PrologParserException {
        // pt.unl.fct.di.novalincs.nohr.plugin.test.Main case for any rule but a fact of arity 0
        if (term.getType() == PrologTermType.STRUCT) {
            ...
            if (bodyTerm != null) // pt.unl.fct.di.novalincs.nohr.plugin.test.Main case for any body but a single atom of arity 0
            {
